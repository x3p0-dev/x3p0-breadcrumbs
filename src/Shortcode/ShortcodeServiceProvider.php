...
final class ShortcodeServiceProvider extends ServiceProvider implements Bootable
{
	/**
	 * @inheritDoc
	 */
	...
	{
		$this->container->singleton(ShortcodeRegistrar::class);
	...
	{
		$this->container->get(ShortcodeRegistrar::class)->boot();
	}
}
