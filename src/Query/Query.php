 ...
 * through the `QueryContext`: it may delegate to another query, run an
...
{
	/**
	 * Stores the context object so subclasses can dispatch further queries,
	 * assemblers, and crumbs into the trail being built.
	 */
	public function __construct(protected readonly QueryContext $context)
	{}
